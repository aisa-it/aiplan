...
import (
	...
	"github.com/aisa-it/aiplan/aiplan.go/pkg/editor"
	_ "github.com/aisa-it/aiplan/aiplan.go/pkg/editor/tiptap"
		...
		},
		{
			...
			descriptionDoc: editor.Document{Elements: []any{
				editor.Paragraph{Content: []any{
					...
					&editor.Image{
						Src:   &url.URL{Scheme: "file", Path: "/home/claude-user/aiplan-oss/aiplan.go/pkg/export/testdata/images/test.png"},
						Width: 150,
