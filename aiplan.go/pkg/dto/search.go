...
//   - Интеграция с типами данных из пакета `github.com/aisa-it/aiplan/pkg/types`.
package dto
...
type SearchLightweightIssue struct {
	...
	StartDate   *types.TargetDateTimeZ `json:"start_date" extensions:"x-nullable" swaggertype:"string"`
	TargetDate  *types.TargetDateTimeZ `json:"target_date" extensions:"x-nullable" swaggertype:"string"`
	CompletedAt *types.TargetDateTimeZ `json:"completed_at" extensions:"x-nullable" swaggertype:"string"`
