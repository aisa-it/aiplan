// Пакет server предоставляет функциональность для управления формами и ответами в системе планирования. Он включает в себя создание, редактирование, получение и обработку форм, а также управление ответами на них. Пакет также предоставляет инструменты для работы с вложениями и валидации данных форм.
//
...
import (
	...
	types2 "github.com/aisa-it/aiplan/aiplan.go/pkg/types"
