...
import (
	...
	statesflow "github.com/aisa-it/aiplan/aiplan.go/pkg/states-flow"
...
var allowedFields []string = []string{"name", "description", "description_text", "description_html", "public", "identifier", "default_assignees", "default_watchers", "project_lead_id", "emoji", "cover_image", "rules_script", "hide_fields", "states_flow", "issue_deletion_allowed", "member_attachments_allowed", "member_properties_allowed"}
...
// @Success 200 {object} dao.PaginationResponse{result=[]dto.ActivityEventFull} "Список активностей проекта"
// @Failure 400 {object} apierrors.DefinedError "Ошибка запроса"
// @Failure 404 {object} apierrors.DefinedError "Проект не найден"
